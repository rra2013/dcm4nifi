...
@Slf4j
public class DeidentifyProcessorTest {
    ...
    @BeforeEach
    public void init() {
        testRunner = TestRunners.newTestRunner(DeidentifyProcessor.class);
    }
    ...
    public void testProcessor() {
        ...
        List<MockFlowFile> success = testRunner.getFlowFilesForRelationship(DeidentifyProcessor.REL_SUCCESS);
        ...
        List<MockFlowFile> error = testRunner.getFlowFilesForRelationship(DeidentifyProcessor.REL_FAILURE);
        ...
        //assertions
        testRunner.assertAllFlowFilesTransferred(DeidentifyProcessor.REL_SUCCESS, dcmObjects.size());
    }
