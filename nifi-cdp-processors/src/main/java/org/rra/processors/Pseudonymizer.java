...
@CapabilityDescription("A DICOM De-Identifier and pseudonymizer. Will deidentify DICOM Objects and replace PID"
        ...
        +"(Tag.PatientName, VR.PN, prefix+\"^\"+postfix). If a dateShift is selected [date_shift] then the AcquisitionDate,AcquisitionDateTime,SeriesDate,ContentDate and StudyDate will be retained and shifted by the value.")
