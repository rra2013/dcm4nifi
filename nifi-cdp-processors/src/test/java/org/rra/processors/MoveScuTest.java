...
public class MoveScuTest {
    ...
    public void testProcessorSuccessSeriesLevel() {
        ...
        log.info("$ $ $ $ Run MoveScu Series Level $ $ $ $ $");
        testRunner.setValidateExpressionUsage(false);
        //Patient/study level
        testRunner.setProperty(MOVE_LEVEL, SERIES_LEVEL);
    ...
    @Test
    public void testProcessorSuccessPatientStudyLevel() {
        ...
        log.info("$ $ $ $ Run MoveScu Study Level $ $ $ $ $");
        testRunner.setValidateExpressionUsage(false);
        //Patient/study level
    ...
    public void testSCUMoveSeries() throws Exception {
        ...
        NifiMoveScu nifiMoveSCU = new NifiMoveScu(DICOM_SERVER_HOST, DICOM_SERVER_PORT, "MOVE_SCU", DICOM_SERVER_AET, DICOM_SERVER_MOVE_AET, dcmConfig);
        String studyInstanceUID = "1.2.840.113845.11.1000000001900555490.20160718102042.2434233";
